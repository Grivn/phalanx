...
// enclave.
func NewUSIGEnclave(enclaveFile string, sealedKey []byte) (*enclaveImpl, error) {
	var err error

	enclave := new(enclaveImpl)
...
func (enclave *enclaveImpl) Destroy() {
...
func (enclave *enclaveImpl) CreateUI(digest Digest) (counter uint64, signature []byte, err error) {
...
// enclave instance.
func (enclave *enclaveImpl) Epoch() uint64 {
...
func (enclave *enclaveImpl) PublicKey() crypto.PublicKey {
...
func (enclave *enclaveImpl) SealedKey() []byte {
