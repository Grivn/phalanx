...
// Source: github.com/Grivn/phalanx-sgx/usig (interfaces: USIG)
...
func (m *MockUSIG) CreateUI(arg0 []byte) (*phalanx_sgx.UI, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUI", arg0)
	ret0, _ := ret[0].(*phalanx_sgx.UI)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUSIG) VerifyUI(arg0 []byte, arg1 *phalanx_sgx.UI, arg2 []byte) error {
	m.ctrl.T.Helper()
