...
func NewFinality(
	...
	return &finalityImpl{
		...
		orderSeq:        orderSeq,
		phalanxAnchor:   newPhalanxAnchorBasedOrdering(conf, meta, executor, logger, ms),
		timestampAnchor: newTimestampAnchorBasedOrdering(conf, meta, executor, logger, ms),
		timestampBased:  newTimestampBasedOrdering(conf, meta, logger, ms),
		reader:          meta,
