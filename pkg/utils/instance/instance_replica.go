...
func NewReplicaInstance(author, id uint64,
	pTracker api.PartialTracker, crypto api.CryptoService,
	sender external.Sender, logger external.Logger) api.ReplicaInstance {
