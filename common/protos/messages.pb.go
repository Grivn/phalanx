...
type PartialSet struct {
	PartialOrders []*PartialOrder `protobuf:"bytes,1,rep,name=PartialOrders,proto3" json:"PartialOrders,omitempty"`
}

func (m *PartialSet) Reset()         { *m = PartialSet{} }
func (m *PartialSet) String() string { return proto.CompactTextString(m) }
func (*PartialSet) ProtoMessage()    {}
func (*PartialSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dc296cbfe5ffcd5, []int{8}
}
func (m *PartialSet) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PartialSet) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PartialSet.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *PartialSet) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PartialSet.Merge(m, src)
}
func (m *PartialSet) XXX_Size() int {
	return m.Size()
}
func (m *PartialSet) XXX_DiscardUnknown() {
	xxx_messageInfo_PartialSet.DiscardUnknown(m)
}

var xxx_messageInfo_PartialSet proto.InternalMessageInfo

func (m *PartialSet) GetPartialOrders() []*PartialOrder {
	if m != nil {
		return m.PartialOrders
	}
	return nil
}
...
type PartialOrderBatch struct {
	Author     uint64              `protobuf:"varint,1,opt,name=Author,proto3" json:"Author,omitempty"`
	PartialSet []*PartialSet       `protobuf:"bytes,2,rep,name=PartialSet,proto3" json:"PartialSet,omitempty"`
...
func (m *PartialOrderBatch) GetPartialSet() []*PartialSet {
	if m != nil {
		return m.PartialSet
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*PartialSet)(nil), "protos.PartialSet")
...
var fileDescriptor_4dc296cbfe5ffcd5 = []byte{
	...
	,
}
...
func (m *PartialSet) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PartialSet) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.PartialOrders) > 0 {
		for _, msg := range m.PartialOrders {
			dAtA[i] = 0xa
			i++
			i = encodeVarintMessages(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *PartialOrderBatch) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PartialSet) > 0 {
		for _, msg := range m.PartialSet {
			dAtA[i] = 0x12
			i++
			i = encodeVarintMessages(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *PartialSet) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PartialSet: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PartialSet: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PartialOrders", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PartialOrders = append(m.PartialOrders, &PartialOrder{})
			if err := m.PartialOrders[len(m.PartialOrders)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *PartialOrderBatch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PartialSet", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PartialSet = append(m.PartialSet, &PartialSet{})
			if err := m.PartialSet[len(m.PartialSet)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
