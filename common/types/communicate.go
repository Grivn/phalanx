...
type RequesterSendChan struct {
	BatchChan chan *commonProto.TxBatch
}
...
type ReliableRecvChan struct {
	// BatchChan is used to receive the batch provided by requester module
	BatchChan chan *commonProto.TxBatch

	// PreOrdering is used to receive the pre-ordering generated by others
	PreOrdering chan *commonProto.PreOrdering

	// Vote is used to receive the votes generated by others
	Vote chan *commonProto.Vote

	// Ordering is used to receive the ordering generated by others
	Ordering chan *commonProto.Ordering
}
